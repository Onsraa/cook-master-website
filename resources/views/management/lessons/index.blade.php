<x-management-layout>
    ...
    <div class="flex justify-end m-2 p-2">
        <a href="{{route('management.lessons.create')}}"
           class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">New Event</a>
    </div>
    <div>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tr>
                <?php
                include(app_path('Helpers/getColumnFromTable.php'));

                $tableName = "cooking_lessons";
                $columns = getColumnFromTable($tableName);
                echo "Columns in $tableName table: " . $columns->implode(', ');
                ?>
